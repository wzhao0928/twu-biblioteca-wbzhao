...
//                      format xxx-xxxx) and a password in order to check-out and return books. User credentials are
//                      predefined, so registering new users is not part of this story.
//    TODO:
...
//                      only be available when the customer is logged in and should only display that customer’s
//                      information.
}
